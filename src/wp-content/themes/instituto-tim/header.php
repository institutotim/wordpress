...
.logo-it {background-color:#00427f;border-bottom:2px solid #82b9e6}
.menu-it {background-color:#075aa5;}
.menu-fixed-bottom-left {left: 0;position: relative;top: 30px;}


.navbar-overtop-tim-en-pt a {color: #82b9e6;}
 #mega-menu-wrap-header-1, .box-it li, .box-it, .creditos, .box-sz1 h2, #searchbox input[type="text"] {font-family: 'TIMSansWeb', Fallback, times-new-roman}
...
.bar-primary {width:305px;height:27px;padding-left:15px;padding-right:15px;padding-top:5px}
.bar-secundary {width:290px;margin-left:9px;height:56px}
#mega-menu-wrap-header-1 .mega-menu-toggle {padding-top: 5px;}
#mega-menu-wrap-header-1 #mega-menu-header-1 > li.mega-menu-item > a.mega-menu-link {color:#004279}
#mega-menu-wrap-header-1 ul#mega-menu-header-1  {margin-top:16px}
.ltrad {margin-right:15px}
.mega-sub-menu {margin-top:20px}
.nav-it {padding-right: 15px}
...
.ltrad {margin-right:8px}
.rm-content {width:300px}
.rm-logo {width:130px}
.rm-creditos {width:170px;padding-top:8px}
}
...
.nav-f {width:430px;float:left;padding-left:30px;display:block;z-index:1;height:90px}
.nav-i {width:402px;height:55px;margin-top:-9px}
.nav-e {width:350px;float:left;padding-bottom:0;padding-top:0;height:48px}
}


@media only screen and (min-width: 768px) {
.container-2 {width:768px}
.bar-primary, .bar-secundary {padding-left:30px;width:768px}
.bar-secundary {height:94px}
#searchbox {margin-top: 5px;height:25px}
.nav-f {width:500px;padding-left:46px}
.logo-project {display:none}
.nav-i {width:402px;height:57px;margin-top:0}
.nav-e {height:35px;margin-top:7px}
#menu-menu-1 li {display:inline-block}
.rodape-mobile {display:none}
#et-featured-posts {margin-top:0}
.ltrad {margin-right:15px}
#mega-menu-wrap-header-1 #mega-menu-header-1 li.mega-menu-flyout.mega-menu-item-has-children > a.mega-menu-link::after, #mega-menu-wrap-header-1 #mega-menu-header-1 li.mega-menu-flyout li.mega-menu-item-has-children > a.mega-menu-link::after, #mega-menu-wrap-header-1 #mega-menu-header-1 > li.mega-menu-item-has-children > a.mega-menu-link::after {color:#00a4e4 !important}
#mega-menu-wrap-header-1 #mega-menu-header-1 > li.mega-menu-item > a.mega-menu-link {font-size: 12px;height: 36px}
#mega-menu-wrap-header-1 ul#mega-menu-header-1  {margin-top:0}
#footer-tim {display:block;width:100%;background-color: #075aa5;margin-top:30px;height:240px;color:#00a4e4}
#footer-tim ul {padding:0}
.footer-tim {width:768px;height:180px;font-size:10pt;padding:30px}
.footer-links {margin-left: 0px}
.footer-links li a {font-size:13px;color: #fff;text-decoration: none;line-height: 0px;margin:0; padding:0}
.footer-links a:hover {color:#00a4e4}
.footer-links li, ul.rede-social {list-style: none;}




.box-it {float:left}
.box-it li {padding-top:11px}
.box-it li a {font-size:9pt;color:#fff}
.box-it li a:hover {color:#82b9e6}
.creditos {width:768px;height:50px;text-align:center;padding-top:25px;color:#00a4e4;font-size:9pt;clear:both}
.box-sz2, .box-sz2 img {width:120px;text-align:center}
.box-sz2 img {margin-top:0px;margin-left:15px}
.box-sz1 {width:140px;padding-left:24px;padding-right:15px}
.box-sz1 h2 {font-family: 'TIMSansWebBold';font-size:14px;margin-top:0px;color:#00a4e4;text-transform: uppercase;}
...
.footer-links2 {margin-left: 0px;margin-top:-7px}
.footer-links2 li a {font-size:15px;font-family: 'TIMSansWebBold';color: #00a4e4;text-decoration: none;line-height: 0px;margin:0; padding:0;text-transform: uppercase}
.footer-links2 li a:hover {color:#fff}
.footer-links2 li {list-style: none;}

.footerborder-left {box-shadow: -1px 0 0 0 rgb(39, 100, 191);border-left: 1px solid #003b7b;height: 150px;-moz-box-shadow:-1px 0 0 0 rgb(39, 100, 191);-webkit-box-shadow: -1px 0 0 0 rgb(39, 100, 191)}

#mega-menu-wrap-header-1 #mega-menu-header-1 > li.mega-menu-flyout ul.mega-sub-menu li.mega-menu-item a.mega-menu-link {margin-top:8px;line-height:20px}
}
...
.logo-project {display:block;width:112px;padding-left:15px;padding-top:27px;margin-top:0;height:94px;z-index:99999}
...
.main {margin-top:0px}
.footer-tim, .creditos {width:1024px}
.footer-tim {height:204px;font-size:10pt;padding:30px;margin:0 auto}
.creditos {font-size:17px;height:66px;margin:0 auto;padding-top:40px}
/*#mega-menu-wrap-header-1 #mega-menu-header-1 li.mega-menu-flyout.mega-menu-item-has-children > a.mega-menu-link::after, #mega-menu-wrap-header-1 #mega-menu-header-1 li.mega-menu-flyout li.mega-menu-item-has-children > a.mega-menu-link::after, #mega-menu-wrap-header-1 #mega-menu-header-1 > li.mega-menu-item-has-children > a.mega-menu-link::after {color:#00a4e4}*/
.bar-primary, .bar-secundary {padding-right:30px}
#searchbox {width: 280px;margin-top: 5px;height:25px}
#searchbox input[type="text"] {background-color:#fff;border: 0px;font-size: 12px;padding: 8px;width: 260px}
.logo2 {width:188px;float:left;padding-right:15px;z-index:99999;height:21px}
.logo2 img {width:188px;z-index:99999}
.nav-f {width:730px;float:left;padding-left:70px;display:block;z-index:1;height:90px}
.nav-i {width:402px;height:48px;margin-top:9px}
.nav-e {width:350px;float:left;padding-bottom:0;padding-top:0;height:44px;margin-top:0}
.box-it li a {font-size:17px;padding:3px}
#footer-tim {display:block;width:100%;background-color: #075aa5;margin-top:30px;height:300px;color:#00a4e4}
.box-sz1, .box-sz2 {width:197px}
.box-sz2 {width:154px;padding-top:0px}
.box-sz1 h2 {font-size:16px;text-transform: uppercase;}
/*.box-sz2, .box-sz2 img {width:134px}*/
.box-sz2 img {width:134px}
.box-sz2 img {margin-top:0px;margin-left:24px}
.footer-links li a {color: #fff;text-decoration: none;line-height: 19px;margin:0; padding:0;font-size:13px}
