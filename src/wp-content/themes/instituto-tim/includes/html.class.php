...
class html {
    ...
    static function getPart($institutotim){
        $_part_vars = array();
        $name = null;
        ...
        $institutotim = 'parts/' . $institutotim;

        if ($name)
            $templates[] = "{$institutotim}-{$name}.php";

        $templates[] = "{$institutotim}.php";
     ...
     * @param string $institutotim
     * 
     * @example part('institutotim'); inclui o arquivo parts/institutotim.php
     * @example part('institutotim', 'name'); inclui o arquivo parts/institutotim-name.php
     * @example part('institutotim', array('var1'=>'valor da var'); inclui o arquivo parts/institutotim.php e torna $var1 acessível
     * @example part('institutotim', 'name', array('var1'=>'valor da var'); inclui o arquivo parts/institutotim-name.php e torna $var1 acessível
     * @example part('institutotim', array('__CACHE'=>3600, 'var1'=>'valor da var'); cacheia a parte por 1 hora
     */
    static function part($institutotim) {
        $_part_vars = array();
        $name = null;
        for ($i = 1; $i < func_num_args(); $i++) {
            $arg = func_get_arg($i);
        ...
        echo self::getPart($institutotim, $name, $_part_vars);
    }
