...
function theme_options_menu() {
    ...
    $topLevelMenuLabel = 'Redes sociais';
    $page_title = 'Opções';
    $menu_title = 'Opções';
...
function theme_options_page_callback_function() {
    ...
    <div class="wrap span-20">
        <h2><?php echo __('Theme Options', 'institutotim'); ?></h2>
    ...
    <?php //////////// Edite a partir daqui //////////  ?>
                ...
                <h3><?php _e("Social Networks", 'institutotim'); ?></h3>

                <div class="span-6 last">


                    <label for="wellcome_title"><strong><?php _e("Facebook", "institutotim"); ?></strong></label><br/>
                    ...
                    <br/><br/>
                    <label for="wellcome_title"><strong><?php _e("Twitter", "institutotim"); ?></strong></label><br/>
                    ...
                    <br/><br/>
                    <label for="wellcome_title"><strong><?php _e("RSS", "institutotim"); ?></strong></label><br/>
    ...
    <?php ///// Edite daqui pra cima ////  ?>
            ...
            <p class="textright clear prepend-top">
                <input type="submit" class="button-primary" value="<?php _e('Save Changes', 'institutotim'); ?>" />
            </p>
        </form>
    </div>
