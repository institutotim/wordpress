...
class url_videos_instituto_class {

    protected static $metabox_config = array(
        'url_videos_instituto', // slug do metabox
        'URL do vídeo', // título do metabox
        'videos_instituto', // array('post','page','etc'), // post types
    ...
    static function metabox(){
        ...
        ?>
        <label> URL do vídeo: <input type="text" name="<?php echo __CLASS__ ?>[url_video_instituto]" value="<?php if( isset($metadata['url_video_instituto'][0]) ) { echo $metadata['url_video_instituto'][0]; } ?>" /></label>
        <?php
    }
...
url_videos_instituto_class::init();
